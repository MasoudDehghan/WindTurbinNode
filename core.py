...
class CoreThread:
    ...
    def __init__(self):
        try:
            ...
            f_handler = RotatingFileHandler('wturbine.log',maxBytes=1024*1024*10,backupCount=10)
    ...
    def run(self):
        ...
        while True:
            try:
                cntr = 0
                #Every 5 minutes : 60 * self.SEND_DATA_INTERVAL_SEC
                if loopCounter == 60:
                    self.saveLastID()
                    loopCounter = 0
    ...
    def repeatedSave(self):
        self.saveLastID()
        self.schedualer.enter(CoreThread.delayBetweenSaveLastID,1,self.repeatedSave)
